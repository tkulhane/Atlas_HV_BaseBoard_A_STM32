...
C_SRCS += \
../LIB/ioLibrary_Driver-master/Internet/DHCP/dhcp.c 

OBJS += \
./LIB/ioLibrary_Driver-master/Internet/DHCP/dhcp.o 

C_DEPS += \
./LIB/ioLibrary_Driver-master/Internet/DHCP/dhcp.d 


# Each subdirectory must supply rules for building sources it contributes
LIB/ioLibrary_Driver-master/Internet/DHCP/%.o LIB/ioLibrary_Driver-master/Internet/DHCP/%.su LIB/ioLibrary_Driver-master/Internet/DHCP/%.cyclo: ../LIB/ioLibrary_Driver-master/Internet/DHCP/%.c LIB/ioLibrary_Driver-master/Internet/DHCP/subdir.mk
...
clean: clean-LIB-2f-ioLibrary_Driver-2d-master-2f-Internet-2f-DHCP

clean-LIB-2f-ioLibrary_Driver-2d-master-2f-Internet-2f-DHCP:
	-$(RM) ./LIB/ioLibrary_Driver-master/Internet/DHCP/dhcp.cyclo ./LIB/ioLibrary_Driver-master/Internet/DHCP/dhcp.d ./LIB/ioLibrary_Driver-master/Internet/DHCP/dhcp.o ./LIB/ioLibrary_Driver-master/Internet/DHCP/dhcp.su

.PHONY: clean-LIB-2f-ioLibrary_Driver-2d-master-2f-Internet-2f-DHCP
